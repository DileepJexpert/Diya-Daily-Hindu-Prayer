...
export const BHAGAVAD_GITA: Scripture = {
  ...
  chapters: [
    ...
    },
    {
      ...
      devanagari: 'कर्मयोग',
      summary: 'Act for the welfare of the world, without attachment; the wise lead by example.',
      verses: [
        {
          ref: '3.21',
          devanagari:
        ...
        },
        {
          ...
          translation:
            'Better your own duty, though imperfect, than another’s done well; to die in one’s own duty is good, another’s path brings danger.',
        },
      ],
    },
    {
      number: 4,
      title: 'Jnana Karma Sanyasa Yoga — Knowledge & Action',
      devanagari: 'ज्ञानकर्मसंन्यासयोग',
      summary: 'The Lord descends age after age to restore dharma; act as an offering, free of attachment.',
      verses: [
        {
          ref: '4.7',
          devanagari:
        ...
        },
        {
          ...
          translation:
            'To protect the good, to destroy the wicked, and to re-establish dharma, I am born in every age.',
          commentary: 'The promise of the avatara — beloved across every tradition.',
        },
      ],
    },
  ],
